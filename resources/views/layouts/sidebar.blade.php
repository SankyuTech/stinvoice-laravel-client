  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{route('stinvoice.index')}}">
        <!-- <img src="{{asset('vendor/stinvoice-client/img/logo-ct-dark.png')}}" class="navbar-brand-img h-100" alt="main_logo"> -->
        <span class="ms-1 font-weight-bold">ST Invoice</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::routeis('stinvoice.saas.index') ? 'active' : '' }}" href="{{route('stinvoice.saas.index',['saas_id' => request()->route('saas_id')])}}">
        ...
        <li class="nav-item">
          <a class="nav-link  {{ Request::routeis('stinvoice.saas.company.index') ? 'active' : '' }}" href="{{route('stinvoice.saas.company.index',['saas_id' => request()->route('saas_id')])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::routeis('stinvoice.index') ? 'active' : '' }}" href="{{route('stinvoice.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop </title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  {{ Request::routeis('stinvoice.company.index') ? 'active' : '' }}" href="{{route('stinvoice.company.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  {{ Request::routeis('stinvoice.invoice.*') ? 'active' : '' }}" href="{{route('stinvoice.invoice.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url(config('stinvoice.back_to_main_application_url')) }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Back To Main App</span>
          </a>
        </li>
